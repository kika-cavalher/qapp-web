...
import { CreateProjectProps, ModalHandles, ProjectProps } from "../../../types/project";
import { Button } from "../button";

import './style.scss'

export const Modals: React.RefForwardingComponent<ModalHandles> = (props, ref) => {
    ...
    function createProject(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
        console.log(titleRef, abbreviationRef, describeRef)
