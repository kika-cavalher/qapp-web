            ...
            <main>
                <div className='page-login--main__container'>
                    ...
                    <div className='page-login--main__login-forms'>
                        <form>
                            <input className='page-login--login-forms__name' type="text" placeholder="Insira o seu e-mail" />
                            <input className='page-login--login-forms__password'type="text" placeholder="Insira a sua senha" />
                            <button className='btn__send'type="submit">Entrar</button>
                        </form>
                    </div>
                </div>
